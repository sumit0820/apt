...
export function HeroPromoPanel() {
  return (
    <div className="flex flex-col items-center text-center lg:ml-[10%]">
      <div className="w-full max-w-[18.2rem] rounded-lg border border-border/80 bg-surface/90 backdrop-blur-sm px-2.5 py-2 sm:px-2.5 sm:py-2.5 hero-promo-card">
        <div className="flex items-center gap-2 text-left">
          ...
          <div className="min-w-0">
            <p className="text-[9px] sm:text-[10px] text-muted-foreground">SEBI RA Registration No.</p>
            <p className="text-sm sm:text-base font-bold tracking-wide text-primary">INH000019460</p>
            <p className="text-[8px] sm:text-[9px] text-muted-foreground leading-snug">
